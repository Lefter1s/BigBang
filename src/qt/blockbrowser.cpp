...
{
    if(Height > pindexBest->nHeight) { return "0x00000c1f9975fb77d2752718845cdea8ce0aae84eb3beef8f3a2e878ecd37aa7"; }
    if(Height < 0) { return "0x00000c1f9975fb77d2752718845cdea8ce0aae84eb3beef8f3a2e878ecd37aa7"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " BBC");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " BBC");
    }
}
